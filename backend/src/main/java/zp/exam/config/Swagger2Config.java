...
public class Swagger2Config {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 自行修改为自己的包路径
                .apis(RequestHandlerSelectors.basePackage("zp"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("在线考试系统 by 赵鹏 at 2023")
                .termsOfServiceUrl("https://github.com/19920625lsg/spring-boot-online-exam")
                .version("2.0")
                .contact(new Contact("zhaopeng", "https://github.com/lsgwr/spring-boot-online-exam", "3126376451@qq.com"))
                .build();
    }
}